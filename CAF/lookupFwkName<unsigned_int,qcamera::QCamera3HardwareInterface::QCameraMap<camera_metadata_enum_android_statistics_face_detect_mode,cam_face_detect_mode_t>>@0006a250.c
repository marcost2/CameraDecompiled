...

{
  ...
  iVar1 = (*(code *)
            PTR_lookupFwkName_unsigned_int_qcamera_QCamera3HardwareInterface_QCameraMap_camera_metadata_enum_android_statistics_face_detect_mode_cam_face_detect_mode_t___0006e074
          )();
  return iVar1;
}
