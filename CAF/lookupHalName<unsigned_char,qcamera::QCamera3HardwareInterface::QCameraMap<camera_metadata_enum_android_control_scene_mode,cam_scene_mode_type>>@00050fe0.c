...
/* int qcamera::lookupHalName<unsigned char,
   ...
   cam_scene_mode_type> const*, unsigned int, unsigned char) */

int qcamera::
    lookupHalName_unsigned_char_qcamera__QCamera3HardwareInterface__QCameraMap_camera_metadata_enum_android_control_scene_mode_cam_scene_mode_type__
...

{
  ...
  if (*(int *)(*(int *)(DAT_00051034 + 0x50ffc) + 0x20) != 0) {
    mm_camera_debug_log();
    return -2;
  }
  return -2;
