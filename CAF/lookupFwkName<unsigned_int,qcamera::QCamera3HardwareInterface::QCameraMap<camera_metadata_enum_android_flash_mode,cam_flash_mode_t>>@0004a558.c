...
/* int qcamera::lookupFwkName<unsigned int,
   ...
   cam_flash_mode_t> const*, unsigned int, unsigned int) */

int qcamera::
    lookupFwkName_unsigned_int_qcamera__QCamera3HardwareInterface__QCameraMap_camera_metadata_enum_android_flash_mode_cam_flash_mode_t__
...

{
  ...
  if (*(int *)(*(int *)(DAT_0004a5a8 + 0x4a576) + 0x28) != 0) {
    mm_camera_debug_log();
    return -2;
  }
  return -2;
