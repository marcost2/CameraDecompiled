...
/* android::List<qcamera::QCamera3HardwareInterface::PendingReprocessResult>::erase(android::List<qcamera::QCamera3HardwareInterface::PendingReprocessResult>::_ListIterator<qcamera::QCamera3HardwareInterface::PendingReprocessResult,
   android::List<qcamera::QCamera3HardwareInterface::PendingReprocessResult>::NON_CONST_ITERATOR>)
    */

void android::List<qcamera::QCamera3HardwareInterface::PendingReprocessResult>::erase
