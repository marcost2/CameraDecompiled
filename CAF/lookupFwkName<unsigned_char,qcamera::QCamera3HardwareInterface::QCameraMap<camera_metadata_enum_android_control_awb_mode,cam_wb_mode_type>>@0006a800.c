...

{
  ...
  iVar1 = (*(code *)
            PTR_lookupFwkName_unsigned_char_qcamera_QCamera3HardwareInterface_QCameraMap_camera_metadata_enum_android_control_awb_mode_cam_wb_mode_type___0006e1e0
