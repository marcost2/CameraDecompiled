...
qcamera::QCamera3Channel::QCamera3Channel
          ...
          FuncDef6 *param_4,FuncDef7 *param_5,cam_padding_info_t *param_6,ulonglong param_7,
...

{
  ...
  *(FuncDef7 **)(this + 100) = param_5;
  *(FuncDef6 **)(this + 0x60) = param_4;
  *(int *)this = *(int *)(DAT_00056624 + 0x565e4) + 8;
  *(uint *)(this + 4) = param_9;
  auVar1 = *(undefined (*) [16])param_6;
  uVar2 = *(undefined8 *)(param_6 + 0x14);
