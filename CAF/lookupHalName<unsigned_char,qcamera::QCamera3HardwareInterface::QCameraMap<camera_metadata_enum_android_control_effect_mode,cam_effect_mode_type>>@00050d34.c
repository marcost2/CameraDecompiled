...
/* int qcamera::lookupHalName<unsigned char,
   ...
   cam_effect_mode_type> const*, unsigned int, unsigned char) */

int qcamera::
    lookupHalName_unsigned_char_qcamera__QCamera3HardwareInterface__QCameraMap_camera_metadata_enum_android_control_effect_mode_cam_effect_mode_type__
...

{
  ...
  if (*(int *)(*(int *)(DAT_00050d88 + 0x50d50) + 0x20) != 0) {
    mm_camera_debug_log();
    return -2;
  }
  return -2;
