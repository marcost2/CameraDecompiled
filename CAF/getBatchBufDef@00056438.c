...

{
  ...
  __aeabi_memclr4(param_1,0x218);
  if (*(QCamera3Memory **)(this + 0x28c) != (QCamera3Memory *)0x0) {
    uVar1 = QCamera3Memory::getFd(*(QCamera3Memory **)(this + 0x28c),0);
    *(undefined4 *)(param_1 + 0x204) = uVar1;
    *(undefined4 *)(param_1 + 8) = 1;
    *(undefined4 *)(param_1 + 0x20c) = *(undefined4 *)(*(int *)(this + 0x14) + 0x1ac);
    *(undefined4 *)(param_1 + 0x210) = *(undefined4 *)(this + 0x28c);
    iVar2 = (**(code **)(**(int **)(this + 0x28c) + 8))(*(int **)(this + 0x28c),0);
