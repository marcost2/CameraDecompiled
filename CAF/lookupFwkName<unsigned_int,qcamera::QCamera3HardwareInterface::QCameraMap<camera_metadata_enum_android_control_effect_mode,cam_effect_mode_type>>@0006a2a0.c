...

{
  ...
  iVar1 = (*(code *)
            PTR_lookupFwkName_unsigned_int_qcamera_QCamera3HardwareInterface_QCameraMap_camera_metadata_enum_android_control_effect_mode_cam_effect_mode_type___0006e088
          )();
  return iVar1;
}
