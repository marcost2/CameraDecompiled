...

{
  ...
  if (param_2 == (void *)0x0) {
    if (*(int *)(*(int *)(DAT_00055048 + 0x55010) + 0x3c) != 0) {
      mm_camera_debug_log();
    }
    uVar4 = 0xfffffff4;
  }
    ...
    if (*(int *)((int)param_2 + 0x284) == 0) {
      uVar4 = __ThumbV7PILongThunk__ZN7qcamera14QCamera3Stream18cleanInvalidateBufEj
    ...
    if (*(char *)(param_1 * 0x218 + iVar1 + 0x21) == '\0') {
      ...
      uVar3 = 0;
      iVar5 = *(int *)(DAT_00055054 + 0x54fb6);
      uVar4 = 0;
      do {
        uVar2 = cleanInvalidateBuf((QCamera3Stream *)param_2,
