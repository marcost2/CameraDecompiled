...
/* android::List<qcamera::QCamera3YUVChannel::PpInfo>::begin() const */

void android::List<qcamera::QCamera3YUVChannel::PpInfo>::begin(void)

{
  ...
  *in_r0;
  ...
  p_Var1 = (_Node *)qcamera::QCamera3Stream::getStreamInfo(*(QCamera3Stream **)(in_r1 + 4));
