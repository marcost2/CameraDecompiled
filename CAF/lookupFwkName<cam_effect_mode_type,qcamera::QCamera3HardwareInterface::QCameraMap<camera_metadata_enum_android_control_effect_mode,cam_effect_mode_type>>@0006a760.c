...

{
  ...
  iVar1 = (*(code *)
            PTR_lookupFwkName_cam_effect_mode_type_qcamera_QCamera3HardwareInterface_QCameraMap_camera_metadata_enum_android_control_effect_mode_cam_effect_mode_type___0006e1b8
          )();
  return iVar1;
}
