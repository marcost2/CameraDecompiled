...
/* int qcamera::lookupHalName<int,
   ...
   cam_test_pattern_mode_t> const*, unsigned int, int) */

int qcamera::
    lookupHalName_int_qcamera__QCamera3HardwareInterface__QCameraMap_camera_metadata_enum_android_sensor_test_pattern_mode_cam_test_pattern_mode_t__
...

{
  ...
  if (*(int *)(*(int *)(DAT_00050e48 + 0x50e10) + 0x20) != 0) {
    mm_camera_debug_log();
    return -2;
  }
  return -2;
