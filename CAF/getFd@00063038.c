...
/* qcamera::QCamera3StreamMem::getFd(unsigned int) */

undefined4 __thiscall qcamera::QCamera3StreamMem::getFd(QCamera3StreamMem *this,uint param_1)

{
  ...
  piVar1 = *(int **)(DAT_00063084 + 0x63046);
  local_18 = *piVar1;
  ...
  uVar2 = QCamera3Memory::getFd(this_00,param_1);
