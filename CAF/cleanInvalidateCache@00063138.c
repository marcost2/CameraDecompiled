...
/* qcamera::QCamera3StreamMem::cleanInvalidateCache(unsigned int) */

undefined4 __thiscall
qcamera::QCamera3StreamMem::cleanInvalidateCache(QCamera3StreamMem *this,uint param_1)

{
  ...
  piVar1 = *(int **)(DAT_00063184 + 0x63146);
  local_18 = *piVar1;
  ...
  uVar2 = QCamera3Memory::cleanInvalidateCache(this_00,param_1);
