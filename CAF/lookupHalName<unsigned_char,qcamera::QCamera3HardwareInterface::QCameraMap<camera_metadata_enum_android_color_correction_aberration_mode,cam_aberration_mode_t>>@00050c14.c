...
/* int qcamera::lookupHalName<unsigned char,
   ...
   cam_aberration_mode_t> const*, unsigned int, unsigned char) */

int qcamera::
    lookupHalName_unsigned_char_qcamera__QCamera3HardwareInterface__QCameraMap_camera_metadata_enum_android_color_correction_aberration_mode_cam_aberration_mode_t__
...

{
  ...
  if (*(int *)(*(int *)(DAT_00050c68 + 0x50c30) + 0x20) != 0) {
    mm_camera_debug_log();
    return -2;
  }
  return -2;
