...

{
  ...
  uVar10 = *(uint *)param_3 * 0x5bd1e995;
  uVar7 = *(uint *)(param_3 + 4) * 0x5bd1e995;
  ...
  if (piVar8 != (int *)0x0) {
    ...
    if (ppiVar9 != (int **)0x0) {
      do {
        ppiVar9 = (int **)*ppiVar9;
        if (ppiVar9 == (int **)0x0) goto LAB_00066aec;
        piVar5 = ppiVar9[1];
        if (piVar5 != piVar11) {
          if ((uVar7 & (uint)piVar8) == 0) {
          ...
          if (piVar5 != unaff_r11) goto LAB_00066aec;
        }
LAB_00066adc:
      } while (((uint)ppiVar9[2] ^ *(uint *)param_3 | (uint)ppiVar9[3] ^ *(uint *)(param_3 + 4)) !=
               0);
      pVar3 = (pair)0x0;
      goto LAB_00066be4;
    }
