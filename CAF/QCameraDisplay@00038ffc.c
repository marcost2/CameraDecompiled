...

{
  ...
  piVar1 = *(int **)(DAT_000391b0 + 0x3900a);
  local_28 = *piVar1;
  android::RefBase::RefBase((RefBase *)(this + 0x9c));
  android::frameworks::displayservice::V1_0::IEventCallback::IEventCallback((IEventCallback *)this);
  iVar2 = *(int *)(DAT_000391b8 + 0x3902c);
  *(int *)(this + 0x9c) = iVar2 + 100;
  *(int *)this = iVar2 + 0xc;
  *(undefined8 *)(this + 8) = 0;
  ...
  *(int *)(this + 0x8c) = (int)((ulonglong)((longlong)iVar2 * 1000000) >> 0x20);
  ...
  iVar2 = *(int *)(DAT_000391dc + 0x3914c);
  if (*(int *)(iVar2 + 0x48) != 0) {
    mm_camera_debug_log();
    if (*(int *)(iVar2 + 0x48) != 0) {
      mm_camera_debug_log();
