...

{
  ...
  pthread_mutex_lock((pthread_mutex_t *)(DAT_0010ccb0 + 0x10cc16));
  set_camera_metadata_vendor_cache_ops(0);
  puVar6 = (undefined4 *)(DAT_0010ccb4 + 0x10cc24);
  ppvVar7 = (void **)*puVar6;
  if (ppvVar7 != (void **)0x0) {
  ...
  pthread_mutex_unlock((pthread_mutex_t *)(DAT_0010ccb8 + 0x10ccaa));
  return;
}
