...
/* android::SortedVector<android::key_value_pair_t<unsigned int, android::String8>>::do_splat(void*,
   void const*, unsigned int) const */

SortedVector_android__key_value_pair_t_unsigned_int_android__String8__ * __thiscall
android::SortedVector<android::key_value_pair_t<unsigned_int,android::String8>>::do_splat
...

{
  ...
  if (param_3 != 0) {
    ...
    do {
      ...
      *(undefined4 *)((String8 *)this + -4) = *param_2;
      iVar1 = android::String8::String8((String8 *)this,(String8 *)((int)param_2 + 4));
