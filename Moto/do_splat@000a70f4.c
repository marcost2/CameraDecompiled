...
/* android::Vector<mm_camera_super_buf_t*>::do_splat(void*, void const*, unsigned int) const */

Vector_mm_camera_super_buf_t__ * __thiscall
android::Vector<mm_camera_super_buf_t*>::do_splat
...

{
  ...
  if (param_3 != 0) {
    ...
    if ((3 < param_3) &&
      ...
      if (bVar5) {
        return (Vector_mm_camera_super_buf_t__ *)puVar2;
      }
    }
    do {
                    /* WARNING: Load size is inaccurate */
      param_3 = param_3 - 1;
      this = (Vector_mm_camera_super_buf_t__ *)(puVar2 + 1);
      *puVar2 = *param_2;
