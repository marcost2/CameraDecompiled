...

{
  ...
  pVar1 = (*(code *)
            PTR___emplace_unique_key_args_unsigned_long_long_unsigned_long_long__android_sp_android_hardware_camera_common_V1_0_helper_VendorTagDescriptor____0011ab18
          )();
  return pVar1;
}
