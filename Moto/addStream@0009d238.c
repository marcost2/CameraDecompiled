...

{
  ...
  if (*(int *)(param_1 + 0x44) == 0) {
    ...
    if (*(int *)(*(int *)(DAT_0009d324 + 0x9d29c) + 0x2c) != 0) {
      mm_camera_debug_log(1,4,DAT_0009d32c + 0x9d2b4,0xc3,DAT_0009d328 + 0x9d2aa);
    }
    iVar1 = (**(code **)(*this + 8))
  ...
  else if (*(int *)(*(int *)(DAT_0009d318 + 0x9d24a) + 0x20) == 0) {
    iVar1 = -0x16;
  }
  else {
    mm_camera_debug_log(1,1,DAT_0009d320 + 0x9d262,0xb1,DAT_0009d31c + 0x9d25a);
    iVar1 = -0x16;
  }
  return iVar1;
}
