...
/* android::SortedVector<android::key_value_pair_t<android::String8,
   android::KeyedVector<android::String8, unsigned int>*>>::do_splat(void*, void const*, unsigned
   int) const */
...
::do_splat(SortedVector_android__key_value_pair_t_android__String8_android__KeyedVector_android__String8_unsigned_int____
...

{
  ...
  if (param_3 != 0) {
    do {
      iVar1 = android::String8::String8((String8 *)param_1,(String8 *)param_2);
